		...
		jQuery.mbYTPlayer = {
						...
						return this.each( function() {
								...
								jQuery( document ).on( "YTAPIReady", function() {
										...
										jQuery( YTPlayer ).on( "YTPChanged", function() {
												...
												new YT.Player( playerID, {
														videoId: YTPlayer.videoID.toString(),
														playerVars: { 'autoplay': 1, 'controls': 0,'autohide':1,'wmode':'opaque','origin':'http://gsrthemes.com' },
														events: {
																'onReady': function( event ) {
																		YTPlayer.player = event.target;
				...
				changeMovie: function( opt ) {
						...
						jQuery( YTPlayer.playerEl ).CSSAnimate( {
								...
								jQuery( YTPlayer ).YTPGetPlayer().cueVideoByUrl( encodeURI( jQuery.mbYTPlayer.locationProtocol + "https://www.youtube.com/v/" + YTPlayer.videoID ), 1, YTPlayer.opt.quality );
								jQuery.mbYTPlayer.checkForState( YTPlayer );
				...
				buildControls: function( YTPlayer ) {
						...
						if( vURL.indexOf( "http" ) < 0 ) vURL = jQuery.mbYTPlayer.locationProtocol + "https://www.youtube.com/watch?v=" + data.videoURL;
